...
# def train_model(model: Module, criterion, optimizer, scheduler, num_epochs: int):
#     since = time.time()
#
...
#             logger.info("Epoch %s/%s", epoch, num_epochs - 1)
#
...
def compute_model_size(model: Module) -> float:
    """Compute a model's size (in MiB).
