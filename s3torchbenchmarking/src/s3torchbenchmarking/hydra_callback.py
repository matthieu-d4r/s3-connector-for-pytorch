...
class ResultCollatingCallback(Callback):
    ...
    results to local file, and (optionally) upload run results to DynamoDB.
    """
    ...
    def on_multirun_end(self, config: DictConfig, **kwargs: Any) -> None:
        ...
        run_results_filepath = self._multirun_path / RUN_FILENAME
    ...
    def _build_run_result(
        ...
        return {
            ...
            "number_of_jobs": len(self._job_results),
